...
if ($command[0]=="data") {
  ...
  //everything worked, so insert the command data and other data
  //but first, replace the data in the command string with 'd', to save space
  $raw_command = "";
...
elseif ($command[0]=="tip") {
  ...
  //everything worked, so insert the command data and tip data
